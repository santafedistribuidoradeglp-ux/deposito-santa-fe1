...
## Admin testing
Admin role is granted if user email is in ADMIN_EMAILS env (backend/.env). To create a test admin, insert a user with role: 'admin' or email matching the whitelist.
